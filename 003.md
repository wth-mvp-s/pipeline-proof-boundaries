...
production et déploiement d’un artefact sans identité versionnée
...
## Exemple — correction
La version est une propriété vérifiée et bloquante de l’artefact

```bash
# Dans l’exemple suivant, le pipeline ne suppose pas l’existence ou la validité d’une version.

# Il vérifie explicitement que l’artefact porte une identité versionnéeet bloque l’exécution en cas d’anomalie.
